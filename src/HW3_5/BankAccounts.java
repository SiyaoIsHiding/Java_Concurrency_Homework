...
public class BankAccounts {
    public static void transferMoney(Account fromAccount,
        ...
        Account smaller = fromAccount.acctNo < toAccount.acctNo? fromAccount : toAccount;
        Account larger = fromAccount.acctNo > toAccount.acctNo? fromAccount : toAccount;
    ...
    static class DollarAmount implements Comparable<DollarAmount> { // safe
    ...
    static class Account {
        ...
        void debit(DollarAmount d) throws InsufficientFundsException { // check and act
